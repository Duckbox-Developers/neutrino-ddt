...
AC_ARG_WITH(boxtype,
	...
	[case "${withval}" in
		...
		tf*)
			...
			BOXMODEL="$withval"
		;;
		hd51|hd60|hd61|bre2ze4k|e4hdultra|vusolo4k|vuduo4k|vuduo4kse|vuultimo4k|vuzero4k|vuuno4kse|vuuno4k|h7|osmio4k|osmio4kplus|dm900|dm920|dcube)
			BOXTYPE="armbox"
			BOXMODEL="$withval"
		;;
		vuduo|vuduo2|vuuno|vuultimo|dm800|dm800se|dm800sev2|dm8000|dm7020hd|dm820|dm7080)
			BOXTYPE="mipsbox"
			BOXMODEL="$withval"
		;;
		*)
...
AS_HELP_STRING([], [valid for armbox: bre2ze4k, hd51, e4hdultra, vusolo4k, vuduo4k, vuduo4kse, vuultimo4k, vuzero4k, vuuno4kse, vuuno4k, h7, dm900, dm920, dcube])
AS_HELP_STRING([], [valid for mipsbox: vuduo, vuduo2, vuuno, vuultimo, dm800, dm800se, dm800sev2, dm8000, dm7020hd, dm820, dm7080])
...
case "$BOXMODEL" in
	bre2ze4k|hd51|e4hdultra|vusolo4k|vuduo4k|vuduo4kse|vuultimo4k|vuzero4k|vuuno4kse|vuuno4k|h7|osmio4k|osmio4kplus)

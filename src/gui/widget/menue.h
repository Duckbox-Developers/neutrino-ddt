...
class CMenuOptionNumberChooser : public CAbstractMenuOptionChooser
{
	...
	public:
		...
		void setLocalizedValue(int special_value)
		{
			localized_value = special_value;
		}
		void setLocalizedValueName(neutrino_locale_t special_value_name)
		{
...
class CMenuWidget : public CMenuTarget, public CComponentsSignals
{
	...
	public:
		...
		void setWizardMode(int _from_wizard)
		{
			from_wizard = _from_wizard;
		};

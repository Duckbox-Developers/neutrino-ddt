	...
	if (newID || parseID == NeutrinoModes::mode_audio || parseID == NeutrinoModes::mode_ts)
	{
		...
		switch (g_settings.lcd4l_dpf_type)
		{
			case 3:
				DPF_Type = "PNG_";
				break;
#if BOXMODEL_VUSOLO4K || BOXMODEL_VUDUO4K || BOXMODEL_VUDUO4KSE || BOXMODEL_VUULTIMO4K || BOXMODEL_VUUNO4KSE || BOXMODEL_VUUNO4K || BOXMODEL_DM800 || BOXMODEL_DM8000 || BOXMODEL_VUDUO2
			case 2:
				DPF_Type = "VUPLUS4K_";
				break;
#endif

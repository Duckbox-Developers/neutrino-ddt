...
const char * const file_extension_list[] =
{
	...
	"mp4",   "mpa",  "mpeg", "mpg",  "ogg",  "pls",  "png",  "sh",
...
const CFile::FileType file_type_list[] =
{
	...
	CFile::FILE_WAV      , CFile::FILE_FLAC     , CFile::FILE_MPG      , CFile::FILE_PICTURE  , CFile::STREAM_PICTURE, CFile::FILE_ISO      , CFile::FILE_PICTURE  , CFile::FILE_PICTURE  ,
	CFile::FILE_MP3      , CFile::FILE_PLAYLIST , CFile::FILE_PLAYLIST , CFile::FILE_AAC      , CFile::FILE_MKV      , CFile::FILE_MP3      , CFile::FILE_MP3      ,
	CFile::FILE_MPG      , CFile::FILE_MP3      , CFile::FILE_MPG      , CFile::FILE_MPG      , CFile::FILE_OGG      , CFile::FILE_PLAYLIST , CFile::FILE_PICTURE  , CFile::FILE_TEXT     ,

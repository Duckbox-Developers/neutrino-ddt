...
template<class T> class cList : public cListBase
{
	public:
		...
		{
			return (T *)object->cListObject::Prev();        // need to call cListObject's members to
		}
		T *Next(const T *object) const
		{
			return (T *)object->cListObject::Next();        // avoid ambiguities in case of a "list of lists"
		}
};
